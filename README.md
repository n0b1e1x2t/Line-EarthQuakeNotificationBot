...
4. [ここ](https://www.linebiz.com/jp/entry/)にアクセスして、「LINE公式アカウントを作成する」を押し、Lineアカウントでログインして、必要情報を入力してアカウントを作成。 (すでにアカウントを作ってある人は不要です。)
5. 管理画面の右上の「設定」をクリック。
6. そして、左のMessaging APIを押す。

!("img/Screenshot 2026-07-14 09.20.58.png")
